...
export declare class BuilderController {
    ...
    constructor(builderService: BuilderService, s3Service: S3Service, associationService: AgentBuilderAssociationService, requirementService: RequirementService, leadService: LeadService);
    ...
    getBuilderRequirements(user: any, page?: number, limit?: number, status?: string): Promise<{
        data: {
            requirements: (import("mongoose").Document<unknown, {}, import("../requirement/entities/requirement.entity").Requirement, {}, {}> & import("../requirement/entities/requirement.entity").Requirement & {
                _id: import("mongoose").Types.ObjectId;
            } & {
                __v: number;
            })[];
    ...
    getBuilderLeads(user: any, page?: number, limit?: number, status?: string): Promise<{
        data: {
            leads: (import("mongoose").Document<unknown, {}, import("../lead/entities/lead.entity").Lead, {}, {}> & import("../lead/entities/lead.entity").Lead & {
                _id: import("mongoose").Types.ObjectId;
            } & {
                __v: number;
            })[];
