...
export declare class OrderController {
    ...
    updateOrderStatus(orderId: string, updateStatusDto: UpdateOrderStatusDto): Promise<{
        data: import("mongoose").Document<unknown, {}, import("./entities/order.entity").OrderDocument, {}, {}> & Order & import("mongoose").Document<unknown, any, any, Record<string, any>, {}> & Required<{
            _id: unknown;
        }> & {
            __v: number;
        };
